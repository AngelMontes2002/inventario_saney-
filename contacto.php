            ...
            <div class="row ">
               <div class="col-md-6">
                  <form id="request" action="inicio/validarCliente.php" class="main_form" method="POST">
                     <div class="row">
                        <div class="col-md-12 ">
                           <input class="contactus" placeholder="Nombre" type="type" name="nombre" required>
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Numero de identidad" type="type" name="documento" required>
                        </div>
                        <div class="col-md-12">
